...
docker run -d --restart=always --name kj1 -d -v /go/soga/:/etc/soga/ --network host vaxilu/soga:latest --type=v2board --server_type=ss --api=webapi --webapi_url=https://520ape.com --webapi_key=xdmyydsxdmyydsxdmyyds --forbidden_ports=22,24,25,26,50,57,105,106,109,110,143,158,209,218,220,465,587,993,995,1109 --proxy_protocol=true --soga_key=Dlsu0lYWQr8hfvG6aUaoNJELWh7bS6Hq --node_id=31


docker run -d --restart=always --name grd1 -d -v /go/soga/:/etc/soga/ --network host vaxilu/soga:latest --type=v2board --server_type=ss --api=webapi --webapi_url=https://soga.grdcloud.com --webapi_key=FHBWFIAWFAWFAWRARWAR --proxy_protocol=true --soga_key=QBWjAnyKi14xGGhW2FzqYbTsvEp6uIeo --forbidden_ports=22,24,25,26,50,57,105,106,109,110,143,158,209,218,220,465,587,993,995,1109 --node_id=31

docker run -d --restart=always --name xz1 -d -v /go/soga/:/etc/soga/ --network host vaxilu/soga:latest --type=v2board --server_type=ss --api=webapi --webapi_url=https://api.xianzheyun.top --webapi_key="m0&]MH&sgqp3GSuF?T(a" --proxy_protocol=true --soga_key=6xT4xSMciKT2DthE1BHpuoBqKJQgJd0t --forbidden_ports=22,24,25,26,50,57,105,106,109,110,143,158,209,218,220,465,587,993,995,1109 --node_id=131,132
