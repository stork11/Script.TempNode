...
docker run -d --name=go-s2 --restart=always --log-opt max-size=5m --log-opt max-file=3 -v /go/soga/:/etc/soga/ -e server_type=ss -e node_id=14501 -p 32501:30000 -p 32501:30000/udp xwhales/soga:go --forbidden_ports=22,24,25,26,50,57,105,106,109,110,143,158,209,218,220,465,587,993,995,1109 --server_type=ss --node_id=14501 
